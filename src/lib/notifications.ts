  ...
  try {
    ...
    await prisma.notification.create({
      data: {
        ...
        title: "Project Proposal Ready for Review",
        message: `${adminName} created a project proposal for you to review and approve`,
        projectId: projectId,
      ...
      adminUsers.map((admin) =>
        prisma.notification.create({
          data: {
            ...
            projectId: null,
            projectName: null,
            actionUrl: `/dashboard?tab=admin-project-creation&helpRequest=true&clientId=${clientId}`,
            read: false,
            created_at: new Date(),
          },
        })
