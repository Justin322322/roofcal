...
export function MaterialSelection({ material, onMaterialChange }: MaterialSelectionProps) {
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-semibold">₱{selectedMaterial.price.toLocaleString()}</span>
            </div>
          </CardContent>
        </Card>
      )}
