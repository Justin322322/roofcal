            ...
            <Tabs defaultValue="overview" className="w-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto mt-4">
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Guidance on selecting roof types for your projects. Choose
                    from various architectural styles and configurations.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Explore material options and trade-offs. Compare durability,
                    cost, and aesthetic considerations for different roofing
                    materials.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Learn how to use the primary calculator workflow for
                    accurate roof measurements and cost estimates.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Use manual entry for custom scenarios when you have specific
                    measurements or unique project requirements.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Access contractor-specific settings and features designed
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Get intelligent suggestions and tips powered by AI to
                    optimize your roofing estimates and project planning.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Manage your active roofing projects. Track progress, update
                    estimates, and organize project documentation.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    View and restore archived calculations and past projects for
                    reference or reuse.
                  </p>
                </TabsContent>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Customize material costs, labor rates, and regional pricing
                    to ensure accurate estimates for your area.
                  </p>
                </TabsContent>
              </div>
            </Tabs>
