...
export function TutorialGuideDialog() {
  ...
  const getRoofTypeDetails = (type: string): RoofTypeDetails => {
    return (
      content.roofTypes[type as keyof typeof content.roofTypes] ||
      content.roofTypes.gable
    );
  };

  // Use same blob base for all tutorial media
  const BLOB_BASE =
    "https://unex0yvstmuqs1jv.public.blob.vercel-storage.com/roof/" as const;
          ...
          <Tabs defaultValue="overview" className="w-full h-full flex flex-col">
              ...
              <div className="p-4 sm:p-6 pb-3 sm:pb-4 border-b">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground mt-1">
                  Complete guide to using RoofCal for accurate roof cost
                  estimation
                </p>
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 ml-4">
                        {content.tabs.overview.keyFeatures?.map(
                          (feature, index) => (
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-3 sm:p-4">
                      ...
                      <p className="text-xs sm:text-sm">
                        {content.tabs.overview.gettingStarted}
                      </p>
                    </div>
                  </div>
                </TabsContent>
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                      <div className="space-y-3">
                        ...
                        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                          {content.tabs["roof-types"].commonRoofs?.map(
                            (roof, index) => (
                              <div
                                key={index}
                      ...
                      <div className="space-y-3">
                        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                          {content.tabs["roof-types"].complexRoofs?.map(
                            (roof, index) => (
                              <div
                                key={index}
                                className="border rounded-lg p-3 cursor-pointer hover:shadow-md transition-shadow group"
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs["roof-types"].selectionTips?.map(
                          (tip, index) => (
                            <li key={index}>• {tip}</li>
                          )
                        )}
                ...
                >
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    {(() => {
                      ...
                      mats.forEach((m) => {
                        const base = m.name.toLowerCase().includes("long span")
                          ? "Long Span"
                          : "Corrugated";
                        if (!byKey[base]) {
                          const defaultImg =
                            base === "Long Span"
                              ? `${BLOB_BASE}long-span.jpg`
                              : `${BLOB_BASE}corrugated.jpg`;
                          byKey[base] = {
                            key: base,
                            image:
                              (m.image?.startsWith("/roof/")
                                ? `${BLOB_BASE}${m.image.replace("/roof/", "")}`
                                : m.image) || defaultImg,
                            items: [],
                          };
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs.materials.selectionGuide?.map(
                          (guide, index) => (
                            <li key={index}>
                              • <strong>{guide.factor}:</strong>{" "}
                              {guide.description}
                            </li>
                          )
                        )}
                    ...
                    <div className="space-y-6 mt-4">
                      {[
                        ...
                        (
                          content.tabs.materials as unknown as {
                            [k: string]: { name: string; image: string }[];
                          }
                        )[section.key]?.length ? (
                          <div key={section.key}>
                            <h4 className="text-base font-medium text-foreground mb-2">
                                      ...
                                      <TooltipTrigger asChild>
                                        <div className="group border rounded-lg p-3 cursor-help hover:bg-muted/50 transition-colors">
                                          <div className="aspect-square bg-muted/30 rounded-lg mb-2 overflow-hidden group-hover:bg-muted/50 transition-colors">
                                            <Image
                                              src={
                                                item.image?.startsWith("/roof/")
                                                  ? `${BLOB_BASE}${item.image.replace("/roof/", "")}`
                                                  : item.image
                                              }
                                              alt={item.name}
                                              width={200}
                ...
                >
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        {content.tabs.calculator.workflow?.map(
                          (step, index) => (
                            <div
                              key={index}
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs.calculator.advancedFeatures?.map(
                          (feature, index) => (
                            <li key={index}>
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-1 ml-4">
                        {Array.isArray(
                          content.tabs["how-to-use"].gettingStarted
                        ) &&
                          content.tabs["how-to-use"].gettingStarted.map(
                            (item, index) => (
                              <li
                                key={index}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        {content.tabs[
                          "how-to-use"
                        ].projectEstimation?.steps?.map((step, index) => (
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs["how-to-use"].bestPractices?.map(
                          (practice, index) => (
                ...
                >
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                        ...
                        <div className="space-y-3">
                          <div className="border rounded-lg p-4">
                            ...
                            <ul className="text-sm space-y-1">
                              {(
                                content.tabs["ai-system"].features as Record<
                                  string,
                                  string[]
                                >
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs["ai-system"].learning?.dataSources?.map(
                          (source, index) => (
                            <li key={index}>
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs["ai-system"].gettingMostFromAI?.map(
                          (tip, index) => (
                            <li key={index}>• {tip}</li>
                          )
                        )}
                ...
                >
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                      ...
                      <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                        <div className="space-y-3">
                          <div className="border rounded-lg p-4">
                            ...
                            <ul className="text-sm space-y-1">
                              {(
                                content.tabs.archive.features as Record<
                                  string,
                                  string[]
                                >
                              )?.projectStorage?.map(
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1">
                        {content.tabs.archive.bestPractices?.map(
                          (practice, index) => (
                            <li key={index}>• {practice}</li>
                          )
                        )}
