      ...
      <div className="container mx-auto px-6 py-4 max-w-7xl">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 flex-1 justify-center">
            ...
            <a href="#about" onClick={handleAboutClick} className="text-muted-foreground hover:text-foreground transition-colors text-sm font-medium cursor-pointer">
              About
            </a>
          </nav>
          ...
          <div className="md:hidden absolute left-0 right-0 top-full border-b border-border bg-card/90 backdrop-blur-md shadow-sm z-20">
            <div className="container mx-auto px-6 py-4 max-w-7xl">
              <div className="grid gap-3">
                <a href="#calculator" className="text-foreground/90 hover:text-foreground text-base font-medium" onClick={() => setMobileOpen(false)}>Calculator</a>
                <a href="#features" className="text-foreground/90 hover:text-foreground text-base font-medium" onClick={() => setMobileOpen(false)}>Features</a>
                <a href="#about" onClick={(e) => { handleAboutClick(e); setMobileOpen(false); }} className="text-foreground/90 hover:text-foreground text-base font-medium cursor-pointer">About</a>
                <div className="h-px bg-border my-2" />
                <div className="grid gap-2">
                  <Button variant="accent" className="w-full" asChild onClick={() => setMobileOpen(false)}>
